...
namespace SalesManagementApp.Core.Dapper.Repository
{
      ...
      where TEntity : class
    {
        ...
        /// <summary>
        /// Execute a Stored Procedure script and read multiple result set
        /// </summary>
        /// <param name="sql">Stored Procedure name</param>
        ///  <param name="parameters">List of parameters</param>
        public async Task ExecuteMultiResultStoredProcedure(string sql, DynamicParameters parameters, Action<SqlMapper.GridReader> callback)
        {
            ...
            var grid = await connection.QueryMultipleAsync(sql, parameters, commandType: CommandType.StoredProcedure, commandTimeout: commandTimeout);
            callback(grid);
        }
